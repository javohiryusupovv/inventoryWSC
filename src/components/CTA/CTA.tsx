                    ...
                    <CardContent className="p-12 text-center">
                        <div className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-xl text-muted-foreground text-pretty">Оставьте заявку — свяжемся в течение 1 часа
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Button
                                    size="lg"
                                    className="flex items-center space-x-2 text-lg px-8 py-6 group"
                                >
